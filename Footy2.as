...
// ************
// バージョン取得関数（ヘルプの3章）
#cfunc	GetFooty2Ver "GetFooty2Ver"
#cfunc	GetFooty2BetaVer "GetFooty2BetaVer"

// ウィンドウ操作関数（ヘルプの4章）
#func	Footy2Create "Footy2Create" int, int, int, int, int, int
#func	Footy2Delete "Footy2Delete" int
#func	Footy2Move "Footy2Move" int, int, int, int, int
#func	Footy2ChangeView "Footy2ChangeView" int, int
#func	Footy2SetFocus "Footy2SetFocus" int, int
#cfunc	Footy2GetWnd "Footy2GetWnd" int, int
#cfunc	Footy2GetWndVSplit "Footy2GetWndVSplit" int
#cfunc	Footy2GetWndHSplit "Footy2GetWndHSplit" int
#cfunc	Footy2GetActiveView "Footy2GetActiveView" int
#func	Footy2Refresh "Footy2Refresh" int

// 編集コマンド（ヘルプの5章）
#func	Footy2Copy "Footy2Copy" int
#func	Footy2Cut "Footy2Cut" int
#func	Footy2Paste "Footy2Paste" int
#func	Footy2Undo "Footy2Undo" int
#func	Footy2Redo "Footy2Redo" int
#cfunc	_Footy2IsEdited "Footy2IsEdited" int
#define	global ctype Footy2IsEdited( %1 ) ( _Footy2IsEdited( %1 ) & 0xff )
#func	_Footy2SelectAll "Footy2SelectAll" int, int
#define	global Footy2SelectAll( %1, %2 = 1 ) _Footy2SelectAll %1, %2
#func	Footy2ShiftLock "Footy2ShiftLock" int, int
#cfunc	_Footy2IsShiftLocked "Footy2IsShiftLocked" int
#define	global ctype Footy2IsShiftLocked( %1 ) ( _Footy2IsShiftLocked( %1 ) & 0xff )
#func	Footy2SearchA "Footy2SearchA" int, sptr, int
#func	Footy2SearchW "Footy2SearchW" int, wptr, int

// ファイル操作（ヘルプの6章）
#func	Footy2CreateNew "Footy2CreateNew" int
#func	Footy2TextFromFileA "Footy2TextFromFileA" int, sptr, int
#func	Footy2TextFromFileW "Footy2TextFromFileW" int, wptr, int
#func	Footy2SaveToFileA "Footy2SaveToFileA" int, sptr, int, int
#func	Footy2SaveToFileW "Footy2SaveToFileW" int, wptr, int, int
#cfunc	Footy2GetCharSet "Footy2GetCharSet" int
#cfunc	Footy2GetLineCode "Footy2GetLineCode" int

// 文字列処理（ヘルプの7章）
#func	Footy2SetSelTextA "Footy2SetSelTextA" int, sptr
#func	Footy2SetSelTextW "Footy2SetSelTextW" int, wptr
#func	Footy2SetTextA "Footy2SetTextA" int, sptr
#func	Footy2SetTextW "Footy2SetTextW" int, wptr
#func	Footy2GetCaretPosition "Footy2GetCaretPosition" int, int, int	// 第2～第3引数はvarptr()を使ってポインタを渡すこと
#func	_Footy2SetCaretPosition "Footy2SetCaretPosition" int, int, int, int
#define	global Footy2SetCaretPosition( %1, %2, %3, %4 = 1 ) _Footy2SetCaretPosition %1, %2, %3, %4
#func	Footy2GetSel "Footy2GetSel" int, int, int, int, int	// 第2～第4引数はvarptr()を使ってポインタを渡すこと
#func	_Footy2SetSel "Footy2SetSel" int, int, int, int, int, int
#define	global Footy2SetSel( %1, %2, %3, %4, %5, %6 = 1 ) _Footy2SetSel %1, %2, %3, %4, %5, %6
#cfunc	Footy2GetTextLengthA "Footy2GetTextLengthA" int, int
#cfunc	Footy2GetTextLengthW "Footy2GetTextLengthW" int, int
#cfunc	Footy2GetSelLength "Footy2GetSelLength" int, int
#func	Footy2GetTextA "Footy2GetTextA" int, sptr, int, int
#func	Footy2GetTextW "Footy2GetTextW" int, wptr, int, int
#func	Footy2GetSelTextA "Footy2GetSelTextA" int, sptr, int, int
#func	Footy2GetSelTextW "Footy2GetSelTextW" int, wptr, int, int
#cfunc	Footy2GetLineW "Footy2GetLineW" int, int
#cfunc	Footy2GetLineA "Footy2GetLineA" int, int, sptr, int
#cfunc	Footy2GetLineLengthW "Footy2GetLineLengthW" int, int
#cfunc	Footy2GetLineLengthA "Footy2GetLineLengthA" int, int
#cfunc	Footy2GetLines "Footy2GetLines" int

// 表示設定（ヘルプの8章）
#func	Footy2AddEmphasisA "Footy2AddEmphasisA" int, sptr, sptr, int, int, int, int, int, int
#func	Footy2AddEmphasisW "Footy2AddEmphasisW" int, wptr, wptr, int, int, int, int, int, int
#func	Footy2FlushEmphasis "Footy2FlushEmphasis" int
#func	Footy2ClearEmphasis "Footy2ClearEmphasis" int
#func	_Footy2SetFontFaceA "Footy2SetFontFaceA" int, int, sptr, int
#define	global Footy2SetFontFaceA( %1, %2, %3, %4 = 1 ) _Footy2SetFontFaceA %1, %2, %3, %4
#func	_Footy2SetFontFaceW "Footy2SetFontFaceW" int, int, wptr, int
#define	global Footy2SetFontFaceW( %1, %2, %3, %4 = 1 ) _Footy2SetFontFaceW %1, %2, %3, %4
#func	_Footy2SetFontSize "Footy2SetFontSize" int, int, int
#define	global Footy2SetFontSize( %1, %2, %3 = 1 ) _Footy2SetFontSize %1, %2, %3
#func	_Footy2SetLineIcon "Footy2SetLineIcon" int, int, int, int
#define	global Footy2SetLineIcon( %1, %2, %3, %4 = 1 ) _Footy2SetLineIcon %1, %2, %3, %4
#func	Footy2GetLineIcon "Footy2GetLineIcon" int, int, int	// 第3引数はvarptr()を使ってポインタを渡すこと
#func	_Footy2SetMetrics "Footy2SetMetrics" int, int, int, int
#define	global Footy2SetMetrics( %1, %2, %3, %4 = 1 ) _Footy2SetMetrics %1, %2, %3, %4
#func	Footy2GetMetrics "Footy2GetMetrics" int, int, int	// 第3引数はvarptr()を使ってポインタを渡すこと
#cfunc	Footy2GetVisibleColumns "Footy2GetVisibleColumns" int, int
#cfunc	Footy2GetVisibleLines "Footy2GetVisibleLines" int, int
#func	_Footy2SetLepal "Footy2SetLepal" int, int, int, int
#define	global Footy2SetLepal( %1, %2, %3, %4 = 1 ) _Footy2SetLepal %1, %2, %3, %4
#func	_Footy2SetColor "Footy2SetColor" int, int, int, int
