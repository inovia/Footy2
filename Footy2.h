...
enum TextModifiedCause
{
	...
	MODIFIED_CAUSE_SETSELTEXT,					//!< Footy2SetSelTextが呼び出された
	MODIFIED_CAUSE_SETLINETEXT,					//!< Footy2SetLineが呼び出された
};
...
FOOTYEXPORT(int) Footy2DeleteKey( int nID );					//!< 削除処理(Deleteキーが押された状態と同じこと)を行います。
